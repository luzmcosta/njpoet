 ...
 */
function avatar() {
    return ''; // '/assets/img/njpoet_logo_black_smallest.png';
}
...
function get_first_image() {
  ...
  if (empty($first_img)) {
      $first_img = get_bloginfo('template_directory') . '/assets/img/njpoet_logo_black_smallest.png';
  }
...
function share_count() {
    // Set page's URL.
    $url = urlencode( 'http://njpoet.com' . $_SERVER['REQUEST_URI'] );
