...
<section id="comments">
  <?php if (have_comments()) : ?>
    <h3><?php printf(_n('One Comment', '%1$s Comments', get_comments_number(), 'roots'), number_format_i18n(get_comments_number()), get_the_title()); ?><a href="#respond" class="respond">Comment</a></h3>
...
<section id="respond">
  <?php if (comments_open()) : ?>
    <h3><?php comment_form_title(__('Respond', 'roots'), __('Respond to %s', 'roots')); ?></h3>
    ...
    <?php else : ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <div class="form-group">
          ...
          <textarea name="comment" id="comment" class="form-control" rows="5" aria-required="true" placeholder="Enter your comment here."></textarea>
        </div>
